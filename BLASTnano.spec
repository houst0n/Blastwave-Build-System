#
# spec file for package BLASTnano
#
...
%build
export CFLAGS="%optflags -I/opt/blast/include -I/opt/blast/include/ncursesw"
export CPPFLAGS="%optflags -I/opt/blast/include -I/opt/blast/include/ncursesw"
export LDFLAGS="%{_ldflags} -R/opt/blast/lib -L/opt/blast/lib -lncursesw"
